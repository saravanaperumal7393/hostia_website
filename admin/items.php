...
$sql= "INSERT INTO tb_style1(imaged)VALUES('".mysqli_real_escape_string($db,$upload_path)."')";
...
$upload_path =$_POST[img];
	...
	$sql = "UPDATE tb_style1 SET imaged='".mysqli_real_escape_string($db,$upload_path)."' WHERE style_id =$_POST[style_id] ";
   ...
   <span class="style51"> <strong><br />
                                        ...
                                        <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#3366CC" bgcolor="#999999" style="border: solid 1px;   border-color:#999999;">
                                          <tr>
                                             ...
                                             <td width="10%" align="center" bgcolor="#FFFFFF" ><span class="style48">Name</span></td>
			  ...
			  ?>
                                          <tr>
                                            <td height="21" align="center" bgcolor="#FFFFFF" class="generalfont"><br>
                                              <img src="<?php echo $imaged; ?>" width="150" height="61" alt="" /><br>
                                            <br></td>
                                             <td width="6%" align="center" valign="middle" bgcolor="#FFFFFF"><span class="style26">Name</span> </td>
                                             <td width="6%" align="center" valign="middle" bgcolor="#FFFFFF"><span class="style26">Old</span> </td>
                                             <td width="6%" align="center" valign="middle" bgcolor="#FFFFFF"><span class="style26">New</span> </td>
                                            <td width="6%" align="center" valign="middle" bgcolor="#FFFFFF"><span class="style26"><?php echo "<a href = 'admin1.php?bid=up&image=$imaged&style_id=$style_id' target=_parent>"; ?> <img src="images/up.png" alt="" /> <?php echo "</a>" ?></span> </td>
                                            <td width="11%" align="center" valign="middle" bgcolor="#FFFFFF" ><span class="style26"><?php echo "<a  href = 'admin1.php?bid=del&image=$imaged&style_id=$style_id' target=_parent>"; ?> <img src="images/del.png" alt="" /> <?php echo "</a>"; ?></span></td>
                                          </tr>
                                          <?php
