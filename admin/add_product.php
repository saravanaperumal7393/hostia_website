...
function watermark_image($oldimage_name, $new_image_name, $ext){
	...
	$width = $height = 1400;  
	 ...
	 if($ext=="jpeg" or $ext=="jpg"  or $ext=="JPEG" or  $ext=="JPG" or $ext=="PNG" or $ext=="png")
...
$intQuery="insert into tbl_product(cat_id,subcat_id,Product_name,Product_desc,thumb_image,Product_image,Product_status)values(".$_REQUEST["catid"].",".$_REQUEST["subcatid"].",'".mysqli_real_escape_string($db,$_REQUEST["pdt_name"])."','".mysqli_real_escape_string($db,$_REQUEST["pdt_desc"])."','".mysqli_real_escape_string($db,$demo_image)."','".mysqli_real_escape_string($db,$demo_image)."',".$_REQUEST["pdt_new"].")";
// print_r($intQuery);
// exit();
	      ...
	      <br>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group" style="display: none;">
                        	...
                        	<select  name="pdt_type" id="pdt_type" class="form-control">
                        		<option value="0">Select Type</option>
 								 ...
 								 <option value="10 Pieces">10 Pieces</option>
 								  ...
 								  <option value="1 Bag">10 Bag</option>
                        ...
                        <div class="col-sm-8">
							...
							<input type="number" name="pdt_old" id="pdt_old"style="max-width:100px;" id="pdt_type" value="<?php if($_REQUEST["pdt_id"])  echo $result["old_rate"];?>" class="form-control">
                        </div>
                    </div>
					  <div class="form-group"  >
                        ...
                        <div class="col-sm-8">
							...
							<input type="text" name="pdt_rate" style="max-width:300px; color:red;"  id="pdt_rate" value="<?php if($_REQUEST["pdt_id"])  echo $result["Product_rate"]; else echo "0.00"; ?>" class="form-control">
                        </div>
                    </div>
			...
			<!-- 		 <div class="form-group"  >
                        ...
                        <div class="col-sm-7">
							...
							<textarea rows="4" cols="50" type="text" name="pdt_desc" id="pdt_desc"  value="<?php if($_REQUEST["pdt_id"])  echo $result["Product_desc"];?>" class="form-control"></textarea>
                        </div>
                    </div> -->
					 ...
					 <div class="form-group"   >
						...
						<!-- 	<textarea rows="4"  cols="50" type="text" name="pdt_desc" id="pdt_desc"  class="form-control"><?php if($_REQUEST["pdt_id"])  echo $result["Product_desc"];?></textarea> -->
					<!-- 	<textarea id="editor1" name="editor1">&lt;p&gt;Initial value.&lt;/p&gt;</textarea> -->
						<textarea rows="4"  id="editor1" cols="50" type="text" name="pdt_desc"   class="form-control"><?php if($_REQUEST["pdt_id"])  echo $result["Product_desc"];?></textarea>
<script type="text/javascript">
