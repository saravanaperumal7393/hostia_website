...
$upload_path =$_POST[img];
	...
	$sql = "UPDATE tbl_new_product SET product_image='".mysqli_real_escape_string($db,$upload_path)."' WHERE id =$_POST[id] ";
			...
			echo "upload/nophoto.jpg";
                ...
                " alt="" width="200" height="100" border="1" /></span>
                        ...
                        <div class="form-group">
                    		 ...
                    		 <div class="col-sm-8">   <input type="text" name="product_name" id="product_name" class="form-control" value="<?php echo $_REQUEST[product_name]; ?>" />
                    		 	</div>
                           </div>
                            <div class="form-group">
                    		  <label class="col-sm-3 control-label">Product Type</label>
                    		 <div class="col-sm-8">   <input type="text" name="product_type" id="product_type" class="form-control" >
                    		 	</div>
                           </div>
                              <div class="form-group">
                    		  <label class="col-sm-3 control-label">Old Price </label>
                    		 <div class="col-sm-8">   <input type="number" name="mrp" id="mrp" class="form-control" >
                    		 	</div>
                           </div>
                                  <div class="form-group">
                    		  <label class="col-sm-3 control-label"> New Price </label>
                    		 <div class="col-sm-8">     <input type="number" name="product_category" id="product_category" class="form-control" >
                    		 	</div>
                           </div>
  ...
  extract( $row );
			  ?>
                                          <tr>
                                            ...
                                            <br></td>
                                            <td width="6%" align="center" valign="middle" bgcolor="#FFFFFF"><span class="style26"><?php echo "<a href = 'product_new.php?bid=up&image=$product_image&id=$id' target=_parent>"; ?> <img src="images/up.png" alt="" /> <?php echo "</a>" ?></span> </td>
                                            <td width="11%" align="center" valign="middle" bgcolor="#FFFFFF" ><span class="style26"><?php echo "<a  href = 'product_new.php?bid=del&image=$product_image&id=$id' target=_parent>"; ?> <img src="images/del.png" alt="" /> <?php echo "</a>"; ?></span></td>
                                          </tr>
                                          <?php
