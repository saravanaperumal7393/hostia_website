...
if(isset($_REQUEST['add_x'])){
	$sel1="select max(subcat_id) as suid from tbl_subcategory";
	$result1=mysqli_fetch_array(mysqli_query($db,$sel1));
	$suid=$result1["suid"]+1;
	$sel2="select max(sortid) as sid from tbl_subcategory";
	$result2=mysqli_fetch_array(mysqli_query($db,$sel2));
	$sid=$result2["sid"]+1;

$intQuery="insert into tbl_subcategory(cat_id,subcat_name,subcat_des,subcat_status,subcat_id,sortid)values('".$_REQUEST["cat_id"]."','".mysqli_real_escape_string($db,$_REQUEST["subcat_name"] )."','".mysqli_real_escape_string($db,$_REQUEST["subcat_des"] )."','1',".$suid.",".$sid.")";


mysqli_query($db,$intQuery);
header("Location:add_subcategory.php?cat_id=".$_REQUEST["cat_id"]."&msg=success&catname=".$_REQUEST["catname"]);}
...
$update="update tbl_subcategory set subcat_name='".mysqli_real_escape_string($db,$_REQUEST["subcat_name"])."'  where subcat_id='".$_REQUEST["subcat_id"]."' and cat_id='".$_REQUEST["cat_id"]."'";
								mysqli_query($db,$update);
         $update1="update tbl_subcategory set subcat_des='".mysqli_real_escape_string($db,$_REQUEST["subcat_des"])."'  where subcat_id='".$_REQUEST["subcat_id"]."' and cat_id='".$_REQUEST["cat_id"]."'";
  ...
  <div class="panel panel-default">
	...
	<div class="col-sm-12 m-b-xs"><p style="text-align:center;font-size:20px;color:#82072e;"><?php echo $_REQUEST["catname"];?></p></div>
      <div class="col-sm-12 m-b-xs">
       ...
       <a href="manage_subcategory.php?cat_id=<?php echo $_REQUEST["cat_id"];?>&catname=<?php echo $_REQUEST["catname"];?>">Manage  Category</a> >> Add Category
			...
			<div class="panel-body">
                    <div class="form-group">
                     ...
                     <div class="form-group" style="display: none;">
                        ...
                        <div class="col-sm-6">
                         <textarea  type="text" name="subcat_des" id="subcat_des" style="height:150px;" class="form-control"><?php if($_REQUEST["subcat_id"]) echo $result["subcat_des"];?></textarea>  
