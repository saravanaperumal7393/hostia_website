                     ...
                     <div class="form-group" style="display: none;">
					  ...
					  <div class="form-group" style="display: none;" >
                        ...
                        <div class="col-sm-8">
							...
							<input type="text" name="pdt_rate" style="max-width:100px;"  id="pdt_rate" value="<?php if($_REQUEST["pdt_id"])  echo $result["Product_rate"]; else echo "0.00"; ?>" class="form-control">
                        </div>
                    </div>
