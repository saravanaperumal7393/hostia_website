...
<form class="form-horizontal bucket-form" method="post" enctype="multipart/form-data" name="add_product" onSubmit="return validate();">
  ...
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
	   ...
	   <a href="add_newarrivals.php?pdt_id=<?php echo $_REQUEST["pid"];?>">Back</a>
     <!--
        <a href="manage_newarrivals.php">Manage New Arrivals</a>  >>  <a href="add_newarrivals.php?pdt_id=<?php echo $_REQUEST["pid"];?>"><?php echo $pdtname;?></a> >> Upload Images
