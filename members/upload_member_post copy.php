...
if (!empty($_FILES['pdfFiles']['name'][0])) {
    ...
    if (!empty($uploadedFiles)) {
        ...
        $sql = "INSERT INTO member_post (member_table_id, member_id, name, company_name, file, content, cus_date) VALUES ('$name_member_id', '$members_id', '$member_name','$company_name',  '$fileLinks', '$Content',  '$cus_date')";
        // echo $sql;
        // exit;
        ...
        $sql = "INSERT INTO member_post ( member_id, name, file, content, cus_date) VALUES ('$members_id', '$member_name',  '', '$Content',  '$cus_date')";
        // echo $sql;
        // exit;
        $result = mysqli_query($db, $sql);
        // echo $sql;
